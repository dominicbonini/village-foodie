...
console.log('\nTEST 1 — operator dots (10 pizzas @19:00), as collectability:')
{
  ...
  expect('18:50 red "Pizza 4/4" (window 18:45 full)', d('18:50').tone === 'red' && d('18:50').label === 'Pizza 4/4', `${d('18:50').tone} "${d('18:50').label}"`)
  expect('18:55 red "Pizza 4/4" (window 18:50 full)', d('18:55').tone === 'red' && d('18:55').label === 'Pizza 4/4', `${d('18:55').tone} "${d('18:55').label}"`)
  expect('19:00 amber "Pizza 2/4" (window 18:55 = 2)', d('19:00').tone === 'amber' && d('19:00').label === 'Pizza 2/4', `${d('19:00').tone} "${d('19:00').label}"`)
